...
retrieval refusals, model refusals, generation failures, uncited answers,
invalid citations, other unverified answers, and grounded answers. Streamlit
displays these records in its server logs; no book context or generated answer
text is included.
